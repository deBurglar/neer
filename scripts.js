...
document.getElementById('product-form').addEventListener('submit', function(event) {
    ...
    const queryString = `?product-type=${encodeURIComponent(productType)}&product-name=${encodeURIComponent(productName)}&product-weight=${encodeURIComponent(productWeight)}`;
...
const translations = {
    ...
    hi: {
        ...
        languages: "भाषाएँ",
        bannerHeading: "नीरवाना में आपका स्वागत है",
